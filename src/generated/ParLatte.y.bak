...
TopDef : Type Ident '(' ListArg ')' Block { AbsLatte.FnDef $1 $2 $4 $6 }
       | 'class' Ident '{' ListClassPole '}' { AbsLatte.ClassDef $2 $4 }
       | 'class' Ident 'extends' Ident '{' ListClassPole '}' { AbsLatte.ClassDefExt $2 $4 $6 }
ClassPole :: { ClassPole }
ClassPole : Type Ident ';' { AbsLatte.ClassFieldDef $1 $2 }
          | Type Ident '(' ListArg ')' Block { AbsLatte.ClassMethodDef $1 $2 $4 $6 }
ListTopDef :: { [TopDef] }
ListTopDef : TopDef { (:[]) $1 } | TopDef ListTopDef { (:) $1 $2 }
ListClassPole :: { [ClassPole] }
ListClassPole : ClassPole { (:[]) $1 }
              | ClassPole ListClassPole { (:) $1 $2 }
Arg :: { Arg }
...
Expr8 : LValue { AbsLatte.ELValue $1 }
      ...
      | LValue '(' ListExpr ')' { AbsLatte.EApp $1 $3 }
